...
<div class="container">
  ...
  <header>
    ...
    <div class="row">
      ...
      <div class="col-sm-6">
        ...
        <div id="logo" class="pull-right hidden-xs"><img src="view/image/logo.png" alt="TTMAI" title="TTMAI" /></div>
  ...
  <div class="modules">
    <div class="row">
      <div class="col-sm-12 text-center"><a href="http://www.ttmai.com" target="_BLANK" class="btn btn-default"><?php echo $text_extension; ?></a></div>
    </div>
  </div>
  <div class="mailing">
    <div class="row">
      <div class="col-sm-12"><i class="fa fa-envelope-o fa-5x"></i>
        ...
        <a href="http://www.ttmai.com" target="_BLANK" class="btn btn-secondary"><?php echo $button_mail; ?></a></div>
    </div>
  </div>
  <div class="support text-center">
    <div class="row">
      <div class="col-sm-4"><a href="http://www.weibo.com/ttmai" class="icon transition"><i class="fa fa-weibo fa-4x"></i></a>
        <h3><?php echo $text_weibo; ?></h3>
        <p><?php echo $text_weibo_description; ?></p>
        <a href="http://www.weibo.com/ttmai"><?php echo $text_weibo_visit; ?></a></div>
      <div class="col-sm-4"><a href="http://www.ttmai.cn" class="icon transition"><i class="fa fa-comments fa-4x"></i></a>
        <h3><?php echo $text_forum; ?></h3>
        <p><?php echo $text_forum_description; ?></p>
        <a href="http://www.ttmai.cn"><?php echo $text_forum_visit; ?></a></div>
      <div class="col-sm-4"><a href="http://www.ttmai.com" class="icon transition"><i class="fa fa-user fa-4x"></i></a>
        <h3><?php echo $text_commercial; ?></h3>
        <p><?php echo $text_commercial_description; ?></p>
        <a href="http://www.ttmai.com" target="_BLANK"><?php echo $text_commercial_visit; ?></a></div>
    </div>
  </div>
