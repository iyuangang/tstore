...
$_['entry_sms_telephone']          = 'SMS Telephone';
$_['entry_fax']                    = 'Fax';
$_['entry_image']                  = 'Image';
...
$_['help_sms']                     = 'Get sms verification or send sms for registration, edit account and convert order to be valid.';
$_['help_icon']                    = 'The icon should be a PNG that is 16px x 16px.';
$_['help_ftp_root']                = 'The directory your installation is stored in. Normally \'public_html/\'.';
...
$_['help_limit_autocomplete']      = 'Determines how many items are shown for autocomplete (products, options, attributes etc).';
...
$_['error_autocomplete']       	   = 'Autocomplete Limit required!';
