...
<?php } ?>
<script src="view/javascript/js.cookie-2.1.2.min.js" type="text/javascript"></script>
</head>
<body>
<div id="container">
  ...
  <ul class="nav pull-right">
    ...
    <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-life-ring fa-lg"></i></a>
      <ul class="dropdown-menu dropdown-menu-right">
        ...
        <li><a href="http://www.ttmai.com" target="_blank"><?php echo $text_homepage; ?></a></li>
        <li><a href="http://www.ttmai.com/index.php?route=blog/all" target="_blank"><?php echo $text_documentation; ?></a></li>
        <li><a href="http://www.ttmai.cn" target="_blank"><?php echo $text_support; ?></a></li>
      </ul>
    </li>
